<?php
namespace Inensus\SunKingMeter\Providers;
use Illuminate\Support\ServiceProvider;
use Inensus\SunKingMeter\Console\Commands\InstallPackage;
use Inensus\SunKingMeter\Providers\EventServiceProvider;
use Inensus\SunKingMeter\Providers\RouteServiceProvider;
use Inensus\SunKingMeter\Providers\ObserverServiceProvider;
...
class SunKingMeterServiceProvider extends ServiceProvider
{
    ...
    {
        $this->mergeConfigFrom(__DIR__ . '/../../config/sun-king-meter.php', 'sun-king-meter');
        $this->app->register(EventServiceProvider::class);
        $this->app->register(ObserverServiceProvider::class);
        $this->app->bind('SunKingMeterApi', SunKingMeterApi::class);
    }

    public function publishConfigFiles()
    {
        $this->publishes([
            __DIR__ . '/../../config/sun-king-meter.php' => config_path('sun-king-meter.php'),
        ]);
    }
    ...
    {
        $this->publishes([
            __DIR__ . '/../resources/assets' => resource_path('assets/js/plugins/sun-king-meter'),
        ], 'vue-components');
    }
